...
public class PushConsumer22 {

    public static void main(String[] args) throws InterruptedException, MQClientException {
        String consumerGroup = "ypp-consumer-producer2";
        for (int i = 4; i < 6; i++
        ) {
            int finalI = i;
            new Thread(() -> {
                ...
                System.out.printf("consumerGroup: %s ,instanceName :%s ,Broadcast Consumer Started.%n", consumerGroup, consumer.getInstanceName());
            }).start();
        }
